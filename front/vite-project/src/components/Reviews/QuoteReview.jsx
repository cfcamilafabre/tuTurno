...
export const QuoteReview = () => {
  return (
    <>
     ...
     <span className={styles.reviewPacient}> Lorem ipsum dolor sit amet consectetur adipisicing elit. Officia repellendus accusamus repellat quos ad expedita nihil quis dicta ut! Esse deleniti ratione atque iste, molestiae labore impedit odit error commodi?</span>
     <span className={styles.namePacient}>- Maria Perez (50)</span>
    </>
  );
};
